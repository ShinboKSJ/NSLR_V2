...
{
    public partial class SystemDiagnostic_LAS_SAT : UserControl
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(SystemDiagnostic_LAS_SAT));
        ...
        /// ///////////////////////////////
        /// </summary>
        public SystemDiagnostic_LAS_SAT()
        {
            InitializeComponent();
            ...
            CbitResult_Power   = new Label[] { led_P_B0, led_P_B1, led_P_B2, led_P_B3, led_P_B4, led_P_B5, led_P_B6  };
        ...
        private void update_timer_Tick(object sender, EventArgs e)
        {
            if (connected)
            {
                ...
                label_OpState.Text = lasSATcontrol.D_OpEnd;
                ...
                var data11 = ReverseBinaryString(data1);
                var data22 = ReverseBinaryString(data2);
        ...
        private void rb_noOp_CheckedChanged(object sender, EventArgs e)
        {
            TX_LaserOpMode = "00";
        }
        ...
        private void rb_LaserMode_NdOff_CheckedChanged(object sender, EventArgs e)
        {
            TX_LaserMode = "02";
        }

        private void rb_LaserMode_NdOn_CheckedChanged(object sender, EventArgs e)
        {
            TX_LaserMode = "03";
        }

        private void btn_SetCommand_Click(object sender, EventArgs e)
        {
            TX_DATA.Append(TX_LaserOpMode).Append(TX_LaserMode).Append(TX_LaserStartStop).Append(TX_LaserOpEnd);
            lasSATcontrol.SetCommand(TX_DATA.ToString());
            log.Info($"[SetCommand DATA] :({TX_DATA.ToString()}) >>  LasOpMode[{TX_LaserOpMode}]  LasMode[{TX_LaserMode}]  LasStartStop[{TX_LaserStartStop}]  LasOpState[{TX_LaserOpEnd}]");
            TX_DATA.Clear();
        }
   }
