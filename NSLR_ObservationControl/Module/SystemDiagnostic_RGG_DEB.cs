...
{
    public partial class SystemDiagnostic_RGG_DEB : UserControl
    {
        ...
        public SystemDiagnostic_RGG_DEB()
        {
            InitializeComponent();

            rggDEBcontrol = RGG_DEB_Controller.instance;
            rggDEBcontrol.SerialConnected += RggControler_SerialConnected;
        ...
        //        rggDEBcontrol.Open_Port(comport);
        ...
        {
            if (e.IsConnected.Equals(IPC_MSG.CONNECTION_RGG_DEB))
            connected = true;
            else
                connected = false;
        }
        ...
        private void do_BIT(string bit)
        {
            ...
            if (connected)
            {
                ...
                if (bit.Equals("PBIT"))
                    rggDEBcontrol.Cmd_Bit("PBIT");
                else if (bit.Equals("CBIT"))
                    rggDEBcontrol.Cmd_Bit("CBIT");
                else if (bit.Equals("IBIT"))
                    rggDEBcontrol.Cmd_Bit("IBIT");
            }
            else
            {
        ...
        private void rb_RGGctrl_set(object sender, EventArgs e)
        {
            ...
            switch (selectedTag)
            {
                case "STANBY":
                    pRGG_Control = "0001";
                    rggDEBcontrol.Cmd_Mode(pRGG_Control);
                    break;
        ...
        private void numGPW_Leave(object sender, EventArgs e)
        {
            ...
            rggDEBcontrol.Cmd_GatePulse_W(pGatePulseWidth);
        }
        ...
        private void numGPSO_Leave(object sender, EventArgs e)
        {
            ...
            rggDEBcontrol.Cmd_GatePulse_SO(pGatePulseStartOffset);
        }
        ...
        private void numAvoidSO_Leave(object sender, EventArgs e)
        {
            ...
            rggDEBcontrol.Cmd_GatePulse_W(pAvoidStartOffset);
        }
        ...
        private void numAvoidWidth_Leave(object sender, EventArgs e)
        {
            ...
            rggDEBcontrol.Cmd_GatePulse_W(pAvoidWidth);
        }
        ...
        private void numUTC_Leave(object sender, EventArgs e)
        {
            ...
            rggDEBcontrol.Cmd_Lut_Utc(pLUT_UTC);
        }
        ...
        private void numTOF_Leave(object sender, EventArgs e)
        {
            ...
            rggDEBcontrol.Cmd_Lut_Delay(pLUT_Delay);
        }
        ...
        private void update_timer_Tick(object sender, EventArgs e)
        {
            if (connected)
            {
                ...
                label_GateStartOffset.Text = rggDEBcontrol.RggGatePulseStartOffset;
                label_GatePulseWidth.Text = rggDEBcontrol.RggGatePulseWidth;

                label_GateStartOffset_m.Text = (rggDEBcontrol.n_RggGatePulseStartOffset *5).ToString() + " (ns)"; 
                label_GateWidth_m.Text = (rggDEBcontrol.n_RggGatePulseWidth*5).ToString() + " (ns)"; ;
                
                var data = ReverseBinaryString(rggDEBcontrol.strBitResultCode);
